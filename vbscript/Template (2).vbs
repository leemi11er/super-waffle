'----------------------------------------------------------------------
'	Navisworks 2014 Exporters Installation Script
...
Const MsgSoftwareTitle = "Autodesk Navisworks Exporters 2014"
...
If strIsInstalled = False Then
	...
	If strIsRunning = True Then
		If DisplayInteractiveMessage = True Then
			Msg = "Navisworks is running so the installation cannot proceed." & vbCrLf & vbCrLf
...
'Install Autodesk Navisworks Exporters 2014
strIsInstalled = IsInstalled (MsgSoftwareTitle)
If strIsInstalled = False Then
